...
@NgModule({
  ...
  providers: [{ provide: RouteReuseStrategy, useClass: IonicRouteStrategy },Globalization,Device,LaunchNavigator,Geolocation,StatusBar,Network,SQLite,CallNumber,BarcodeScanner,Camera,FileTransfer,File],
